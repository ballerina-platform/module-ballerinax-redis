...
/**
 * {@code getBit} Maps with "GETBIT" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class GetBit extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        int offset = (int) context.getIntArgument(0);
        BInteger result = getBit(key, offset, redisDataSource);
        try {
