...
/**
 * {@code {@link SUnion}} Maps with "SUNION" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class SUnion extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        BStringArray result = sUnion(redisDataSource, createArrayFromBStringArray(keys));
        try {
