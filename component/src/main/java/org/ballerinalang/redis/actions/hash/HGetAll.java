...
/**
 * {@code {@link HGetAll}} Maps with "HGETALL" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class HGetAll extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        BMap<String, BString> result = hGetAll(key, redisDataSource);
        try {
