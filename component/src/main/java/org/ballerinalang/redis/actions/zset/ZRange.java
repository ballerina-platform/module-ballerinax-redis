...
/**
 * {@code {@link ZRange}} Maps with "ZRANGE" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class ZRange extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        BStringArray result = zRange(key, min, max, redisDataSource);
        try {
