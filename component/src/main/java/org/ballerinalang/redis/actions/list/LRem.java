...
/**
 * {@code lRem} Maps with "LREM" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class LRem extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        long count = (int) context.getIntArgument(0);
        String value = context.getStringArgument(1);
        BInteger result = lRem(key, count, value, redisDataSource);
        try {
