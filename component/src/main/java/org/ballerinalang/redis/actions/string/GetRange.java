...
/**
 * {@code getRange} Maps with "GETRANGE" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class GetRange extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        int start = (int) context.getIntArgument(0);
        int end = (int) context.getIntArgument(1);
        BString result = getRange(key, start, end, redisDataSource);
        try {
