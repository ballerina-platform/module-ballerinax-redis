...
/**
 * {@code {@link LIndex}} Maps with "LINDEX" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class LIndex extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        long index = (int) context.getIntArgument(0);
        BString result = lIndex(key, index, redisDataSource);
        try {
