...
/**
 * {@code {@link Auth}} Maps with "AUTH" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class Auth extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        String password = context.getStringArgument(0);
        BString result = auth(password, redisDataSource);
        try {
