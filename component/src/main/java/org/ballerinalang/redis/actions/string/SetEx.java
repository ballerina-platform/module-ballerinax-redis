...
/**
 * {@code setex} Maps with "SETEX" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class SetEx extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        int expirationPeriodSeconds = (int) context.getIntArgument(0);
        BString result = setEx(key, value, expirationPeriodSeconds, redisDataSource);
        try {
