...
/**
 * {@code setRange} Maps with "SETRANGE" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class SetRange extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        long offset = (int) context.getIntArgument(0);
        String value = context.getStringArgument(1);
        BInteger result = setRange(key, offset, value, redisDataSource);
        try {
