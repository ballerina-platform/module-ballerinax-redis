...
/**
 * {@code {@link LInsert}} Maps with "LINSERT" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class LInsert extends AbstractRedisAction {
    ...
    public ConnectorFuture execute(Context context) {
        ...
        boolean before = getBooleanArgument(context, 0);
        String pivot = getStringArgument(context, 1);
        String value = getStringArgument(context, 2);
        BInteger result = lInsert(key, before, pivot, value, redisDataSource);
