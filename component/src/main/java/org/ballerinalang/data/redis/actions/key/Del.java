...
/**
 * {@code {@link Del}} Maps with "DEL" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class Del extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        BInteger result = del(redisDataSource, createArrayFromBStringArray(keys));
        try {
