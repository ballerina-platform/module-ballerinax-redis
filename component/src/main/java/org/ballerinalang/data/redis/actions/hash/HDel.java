...
/**
 * {@code {@link HDel}} Maps with "HDEL" operation of Redis.
 *
 * @since 0.5.0
 */
...
public class HDel extends AbstractRedisAction {
    ...
    public ConnectorFuture execute(Context context) {
        ...
        BStringArray fields = (BStringArray) getRefArgument(context, 1);
        BInteger result = hDel(key, redisDataSource, createArrayFromBStringArray(fields));
