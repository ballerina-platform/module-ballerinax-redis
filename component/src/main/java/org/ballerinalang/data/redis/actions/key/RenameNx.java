...
/**
 * {@code {@link RenameNx}} Maps with "RENAMENX" operation of Redis.
 *
 * @since 0.5.0
 */
@BallerinaFunction(orgName = "ballerina",
                   packageName = "data.redis",
                   functionName = "renameNx",
                   receiver = @Receiver(type = TypeKind.STRUCT,
                                        structType = "ClientConnector"))
public class RenameNx extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        String newName = context.getStringArgument(1);
        BBoolean result = renameNx(key, newName, redisDataSource);
        try {
