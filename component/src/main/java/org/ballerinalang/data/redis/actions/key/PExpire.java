...
package org.ballerinalang.data.redis.actions.key;
...
/**
 * {@code {@link PExpire}} Maps with "PEXPIRE" operation of Redis.
 *
 * @since 0.5.0
 */
@BallerinaFunction(orgName = "ballerina",
                   packageName = "data.redis",
                   functionName = "pExpire",
                   receiver = @Receiver(type = TypeKind.STRUCT,
                                        structType = "ClientConnector"))
public class PExpire extends AbstractRedisAction {
    ...
    public void execute(Context context) {
        ...
        long milliSeconds = (int) context.getIntArgument(0);
        BBoolean result = pExpire(key, milliSeconds, redisDataSource);
        try {
