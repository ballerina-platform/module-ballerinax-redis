...
public native function <ClientConnector c> append (string key, string value) returns (int);

@Description {value:"Count set bits in a string"}
@Param {value:"key:The key"}
@Return {value:"The number of bits set to 1"}
public native function <ClientConnector c> bitCount (string key) returns (int);
...
input string"}
public native function <ClientConnector c> bitOpAnd (string destination, string[] keys) returns (int);
...
@Return {value:"The size of the string stored in the destination key, that is equal to the size of the longest
input string"}
public native function <ClientConnector c> bitOpOr (string destination, string[] keys) returns (int);

@Description {value:"Perform bitwise NOT on a string"}
@Param {value:"destination:Result key of the operation"}
@Param {value:"value:Input keys to perform AND between"}
@Return {value:"The size of the string stored in the destination key"}
public native function <ClientConnector c> bitOpNot (string destination, string key) returns (int);
...
@Return {value:"The size of the string stored in the destination key, that is equal to the size of the longest
input string"}
public native function <ClientConnector c> bitOpXor (string destination, string[] key) returns (int);

@Description {value:"Decrement the integer value of a key by one"}
@Param {value:"key:The key"}
@Return {value:"The value of the key after the decrement"}
public native function <ClientConnector c> decr (string key) returns (int);

@Description {value:"Decrement the integer value of a key by the given number"}
@Param {value:"key:The key"}
@Return {value:"The value of the key after the decrement"}
public native function <ClientConnector c> decrBy (string key, int value) returns (int);
...
public native function <ClientConnector c> getBit (string key, int offset) returns (int);
...
public native function <ClientConnector c> getRange (string key, int start, int end) returns (string);
...
public native function <ClientConnector c> getSet (string key, string value) returns (string);

@Description {value:"Get the value of a key"}
@Param {value:"key:The key"}
@Return {value:"the value of the key, or null when key does not exist"}
public native function <ClientConnector c> get (string key) returns (string);

@Description {value:"Increment the integer value of a key by one"}
@Param {value:"key:The key"}
@Return {value:"the value of the key after increment"}
public native function <ClientConnector c> incr (string key) returns (int);

@Description {value:"Increment the integer value of a key by the given amount"}
@Param {value:"key:The key"}
@Param {value:"value:The amount to increment"}
@Return {value:"the value of the key after increment"}
public native function <ClientConnector c> incrBy (string key, int value) returns (int);

@Description {value:"Increment the integer value of a key by the given amount"}
@Param {value:"key:The key"}
@Param {value:"value:The amount to increment"}
@Return {value:"the value of the key after increment"}
public native function <ClientConnector c> incrByFloat(string key, float value) returns (float);

@Description {value:"Get the values of all the given keys"}
@Param {value:"key:The key"}
@Return {value:"Array of values at the specified keys"}
public native function <ClientConnector c> mGet (string[] keys) returns (string[]);
...
public native function <ClientConnector c> mSet (map keyValueMap) returns (string);

@Description {value:"Set multiple keys to multiple values, only if none of the keys exist"}
@Param {value:"keyValueMap:A map of key-value pairs to be set"}
@Return {value:"A string with the value \"OK\" if the operation was successful"}
public native function <ClientConnector c> mSetNx (map keyValueMap) returns (boolean);
...
public native function <ClientConnector c> pSetEx (string key, string value, int expirationTime) returns (string);
...
public native function <ClientConnector c> setBit (string key, int value, int offset) returns (int);
...
@Return {value:"New value of the key"}
public native function <ClientConnector c> setEx (string key, string value, int expirationPeriodSeconds) returns (string);

@Description {value:"Set the value of a key, only if the key does not exist"}
@Param {value:"key:The key"}
@Param {value:"value:The value to be set"}
@Return {value:"New value of the key"}
public native function <ClientConnector c> setNx (string key, string value) returns (boolean);
...
public native function <ClientConnector c> setRange (string key, int offset, string value) returns (int);
...
public native function <ClientConnector c> strln (string key) returns (int);

@Description {value:"Set the value of a key"}
@Param {value:"key:The key"}
@Param {value:"value:The value to be set"}
@Return {value:"A string with the value \"OK\" if the operation was successful"}
public native function <ClientConnector c> setVal (string key, string value) returns (string);
...
public native function <ClientConnector c> lPush (string key, string[] values) returns (int);
...
public native function <ClientConnector c> lPop (string key) returns (string);

@Description {value:"Prepend one or multiple values to a list, only if the list exists"}
@Param {value:"key:The key"}
@Param {value:"value:The values to be prepended"}
@Return {value:"The length of the list after the push operation(s)"}
public native function <ClientConnector c> lPushX (string key, string[] values) returns (int);
...
element."}
public native function <ClientConnector c> bLPop (int timeOut, string[] keys) returns (map);
...
key being  the name of the key where an element was popped and the second element  being the value of the popped
element."}
public native function <ClientConnector c> bRPop (int timeOut, string[] keys) returns (map);
...
public native function <ClientConnector c> lIndex (string key, int index) returns (string);
...
@Return {value:"the length of the list after the insert operation, or -1 when the value pivot not
 found"}
public native function <ClientConnector c> lInsert (string key, boolean before, string pivot, string value) returns (int);

@Description {value:"Get the length of a list"}
@Param {value:"key:The key"}
@Return {value:"The length of the list at key"}
public native function <ClientConnector c> lLen (string key) returns (int);
...
public native function <ClientConnector c> lRange (string key, int start, int stop) returns (string[]);
...
public native function <ClientConnector c> lRem (string key, int count, string value) returns (int);
...
@Param {value:"value:The value to be set"}
@Return {value:"A string with the value \"OK\" if the operation was successful"}
public native function <ClientConnector c> lSet (string key, int index, string value) returns (string);
...
@Return {value:"A string with the value \"OK\" if the operation was successful"}
public native function <ClientConnector c> lTrim (string key, int start, int stop) returns (string);
...
public native function <ClientConnector c> rPop (string key) returns (string);
...
public native function <ClientConnector c> rPopLPush (string source, string destination) returns (string);
...
public native function <ClientConnector c> rPush (string key, string[] values) returns (int);

@Description {value:" Append one or multiple values to a list, only if the list exists"}
@Param {value:"key:The key of the list"}
@Param {value:"values:Array of values to be appended"}
@Return {value:"The length of the list after the push operation"}
public native function <ClientConnector c> rPushX (string key, string[] values) returns (int);
...
public native function <ClientConnector c> sAdd (string key, string[] values) returns (int);

@Description {value:"Get the number of members in a set"}
@Param {value:"key:The key of the set"}
@Return {value:"The cardinality (number of elements) of the set"}
public native function <ClientConnector c> sCard (string key) returns (int);
...
public native function <ClientConnector c> sDiff (string[] keys) returns (string[]);
...
public native function <ClientConnector c> sDiffStore (string destination, string[] keys) returns (int);

@Description {value:"Return the intersection of the provided sets"}
@Param {value:"keys:The keys of the sets to be intersected"}
@Return {value:"An array of members of the resulting set"}
public native function <ClientConnector c> sInter (string[] keys) returns (string[]);

@Description {value:"Obtain the intersection of the provided sets and store at the provided destination"}
@Param {value:"destination:The destination key of the resulting set"}
@Param {value:"keys:The keys of the sets to be intersected"}
@Return {value:"An array of members of the resulting set"}
public native function <ClientConnector c> sInterStore (string destination, string[] keys) returns (int);
...
public native function <ClientConnector c> sIsMember (string key, string value) returns (boolean);

@Description {value:"Get all the members in a set"}
@Param {value:"key:The key of the set"}
@Return {value:"Array of all members in the set"}
public native function <ClientConnector c> sMembers (string key) returns (string[]);
...
public native function <ClientConnector c> sMove (string source, string destination, string member) returns (boolean);
...
public native function <ClientConnector c> sPop (string key, int count) returns (string[]);
...
public native function <ClientConnector c> sRandMember (string key, int count) returns (string[]);
...
public native function <ClientConnector c> sRem (string key, string[] members) returns (int);
...
public native function <ClientConnector c> sUnion (string[] keys) returns (string[]);

@Description {value:"Return the union of multiple sets"}
@Param {value:"destination: The destination key of the resulting set"}
@Param {value:"keys:Array of keys of sets"}
@Return {value:"Number of members of the resulting set"}
public native function <ClientConnector c> sUnionStore (string destination, string[] keys) returns (int);
...
public native function <ClientConnector c> zAdd (string key, map memberScoreMap) returns (int);
...
public native function <ClientConnector c> zCard (string key) returns (int);
...
public native function <ClientConnector c> zCount (string key, float min, float max) returns (int);
...
public native function <ClientConnector c> zIncrBy (string key, float amount, string member) returns (float);
...
public native function <ClientConnector c> zInterStore (string destination, string[] keys) returns (int);
...
public native function <ClientConnector c> zLexCount (string key, string min, string max) returns (int);
...
public native function <ClientConnector c> zRange (string key, int min, int max) returns (string[]);
...
public native function <ClientConnector c> zRangeByLex (string key, string min, string max) returns (string[]);
...
public native function <ClientConnector c> zRevRangeByLex (string key, string min, string max) returns (string[]);
...
public native function <ClientConnector c> zRangeByScore (string key, float min, float max) returns (string[]);
...
public native function <ClientConnector c> zRank (string key, string member) returns (int);
...
public native function <ClientConnector c> zRem (string key, string[] members) returns (int);
...
public native function <ClientConnector c> zRemRangeByLex (string key, string min, string max) returns (int);
...
@Param {value:"max:The maximum index of the range"}
@Return {value:"The number of members removed from the sorted set"}
public native function <ClientConnector c> zRemRangeByRank (string key, int min, int max) returns (int);
...
@Param {value:"max:The maximum score of the range"}
@Return {value:"The number of members removed from the sorted set"}
public native function <ClientConnector c> zRemRangeByScore (string key, float min, float max) returns (int);
...
@Param {value:"max:The maximum index of the range"}
@Return {value:"The number of elements in the specified index range"}
public native function <ClientConnector c> zRevRange (string key, int min, int max) returns (string[]);
...
public native function <ClientConnector c> zRevRangeByScore (string key, float min, float max) returns (string[]);

@Description {value:"Determine the index of a member in a sorted set"}
@Param {value:"key:The key of the sorted set"}
@Param {value:"member:The member of which the index needs to be obtained"}
@Return {value:"The index of the member"}
public native function <ClientConnector c> zRevRank (string key, string member) returns (int);
...
public native function <ClientConnector c> zScore (string key, string member) returns (float);
...
public native function <ClientConnector c> zUnionStore (string dest, string[] keys) returns (int);
...
public native function <ClientConnector c> hDel (string key, string[] fields) returns (int);
...
public native function <ClientConnector c> hExists (string key, string field) returns (boolean);

@Description {value:"Get the value of a hash field"}
@Param {value:"key:The key of the hash"}
@Param {value:"field:The field"}
@Return {value:"The value of the field"}
public native function <ClientConnector c> hGet (string key, string field) returns (string);

@Description {value:"Get the all values of a hash"}
@Param {value:"key:The key of the hash"}
@Return {value:"Map of field-value pairs"}
public native function <ClientConnector c> hGetAll (string key) returns (map);
...
@Param {value:"amount:The amount to increment"}
@Return {value:"The value of the field"}
public native function <ClientConnector c> hIncrBy (string key, string field, int amount) returns (int);
...
@Param {value:"amount:The amount to increment"}
@Return {value:"The value of the field"}
public native function <ClientConnector c> hIncrByFloat (string key, string field, float amount) returns (float);

@Description {value:"Get all the fields in a hash"}
@Param {value:"key:The key of the hash"}
@Return {value:"Array of hash fields"}
public native function <ClientConnector c> hKeys (string key) returns (string[]);

@Description {value:"Get the number of fields in a hash"}
@Param {value:"key:The key of the hash"}
@Return {value:"Number of fields"}
public native function <ClientConnector c> hLen (string key) returns (int);

@Description {value:"Get the values of all the given hash fields"}
@Param {value:"key:The key of the hash"}
@Param {value:"fields:Array of hash fields"}
@Return {value:"Map of field-value pairs"}
public native function <ClientConnector c> hMGet (string key, string[] fields) returns (map);

@Description {value:"Set multiple hash fields to multiple values"}
@Param {value:"key:The key of the hash"}
@Param {value:"fieldValueMap:Map of field-value pairs"}
@Return {value:"A string with the value \"OK\" if the operation was successful"}
public native function <ClientConnector c> hMSet (string key, map fieldValueMap) returns (string);
...
public native function <ClientConnector c> hSet (string key, string field, string value) returns (boolean);
...
public native function <ClientConnector c> hSetNx (string key, string field, string value) returns (boolean);
...
@Return {value:"length of the field value, or 0 when field is not present in the hash or key does
 not exist at all"}
public native function <ClientConnector c> hStrln (string key, string field) returns (int);
...
public native function <ClientConnector c> hVals (string key) returns (string[]);
...
public native function <ClientConnector c> del(string[] keys) returns (int);
...
public native function <ClientConnector c> exists(string[] keys) returns (int);
...
public native function <ClientConnector c> expire(string key, int seconds) returns (boolean);
...
public native function <ClientConnector c> keys(string pattern) returns (string[]);
...
public native function <ClientConnector c> move(string key, int database) returns (boolean);
...
public native function <ClientConnector c> persist(string key) returns (boolean);
...
@Return {value:"boolean true if the timeout was set. boolean false if key does not exist or the timeout could not
 be set"}
public native function <ClientConnector c> pExpire(string key, int timeMilliSeconds) returns (boolean);
...
public native function <ClientConnector c> renameNx(string key, string newName) returns (boolean );
...
public native function <ClientConnector c> sort(string key) returns (string[]);
...
public native function <ClientConnector c> ttl(string key) returns (int);

@Description {value:"Determine the type stored at key"}
@Param {value:"key:The key of which the type needs to be obtained"}
@Return {value:"Time to live in seconds or a negative value in order to signal an error"}
public native function <ClientConnector c> redisType(string key) returns (string);
...
@Return {value:"A string with the value \"OK\" if the operation was successful"}
public native function <ClientConnector c> auth(string password) returns (string);
...
public native function <ClientConnector c> echo(string message) returns (string);

@Description {value:"Ping the server"}
@Return {value:"A string with the value \"PONG\" if the operation was successful"}
public native function <ClientConnector c> ping() returns (string);

@Description {value:"Close the connection"}
@Return {value:"A string with the value \"OK\""}
public native function <ClientConnector c> quit () returns (string);
