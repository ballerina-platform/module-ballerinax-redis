...
public type RedisClient object {
    ...
    public native function append (string key, string value) returns (int|RedisConnectorError);

    @Description {value:"Count set bits in a string"}
    @Param {value:"key:The key"}
    @Return {value:"The number of bits set to 1"}
    public native function bitCount (string key) returns (int|RedisConnectorError);
...
input string"}
    ...
    public native function decr (string key) returns (int|RedisConnectorError);

    @Description {value:"Decrement the integer value of a key by the given number"}
    @Param {value:"key:The key"}
    @Return {value:"The value of the key after the decrement"}
    public native function decrBy (string key, int value) returns (int|RedisConnectorError);
    ...
    public native function getBit (string key, int offset) returns (int|RedisConnectorError);
    ...
    public native function getRange (string key, int start, int end)
    ...
    public native function getSet (string key, string value) returns (string|RedisConnectorError);

    @Description {value:"Get the value of a key"}
    @Param {value:"key:The key"}
    @Return {value:"the value of the key, or null when key does not exist"}
    public native function get (string key) returns (string|RedisConnectorError);

    @Description {value:"Increment the integer value of a key by one"}
    @Param {value:"key:The key"}
    @Return {value:"the value of the key after increment"}
    public native function incr (string key) returns (int|RedisConnectorError);

    @Description {value:"Increment the integer value of a key by the given amount"}
    @Param {value:"key:The key"}
    @Param {value:"value:The amount to increment"}
    @Return {value:"the value of the key after increment"}
    public native function incrBy (string key, int value) returns (int|RedisConnectorError);

    @Description {value:"Increment the integer value of a key by the given amount"}
    @Param {value:"key:The key"}
    @Param {value:"value:The amount to increment"}
    @Return {value:"the value of the key after increment"}
    public native function incrByFloat (string key, float value) returns (float|RedisConnectorError);

    @Description {value:"Get the values of all the given keys"}
    @Param {value:"key:The key"}
    @Return {value:"Array of values at the specified keys"}
    public native function mGet (string[] keys) returns (string[]|RedisConnectorError);
    ...
    public native function mSet (map keyValueMap) returns (string|RedisConnectorError);

    @Description {value:"Set multiple keys to multiple values, only if none of the keys exist"}
    @Param {value:"keyValueMap:A map of key-value pairs to be set"}
    @Return {value:"A string with the value \"OK\" if the operation was successful"}
    public native function mSetNx (map keyValueMap) returns (boolean|RedisConnectorError);
    ...
    public native function setBit (string key, int value, int offset) returns (int|RedisConnectorError);
    ...
    @Param {value:"value:The value to be set"}
    @Return {value:"New value of the key"}
    public native function setNx (string key, string value) returns (boolean|RedisConnectorError);
    ...
    public native function strln (string key) returns (int|RedisConnectorError);

    @Description {value:"Set the value of a key"}
    @Param {value:"key:The key"}
    @Param {value:"value:The value to be set"}
    @Return {value:"A string with the value \"OK\" if the operation was successful"}
    public native function setVal (string key, string value) returns (string|RedisConnectorError);
    ...
    public native function lPush (string key, string[] values) returns (int|RedisConnectorError);
    ...
    public native function lPop (string key) returns (string|RedisConnectorError);

    @Description {value:"Prepend one or multiple values to a list, only if the list exists"}
    @Param {value:"key:The key"}
    @Param {value:"value:The values to be prepended"}
    @Return {value:"The length of the list after the push operation(s)"}
    public native function lPushX (string key, string[] values) returns (int|RedisConnectorError);
...
element."}
    public native function bLPop (int timeOut, string[] keys) returns (map|RedisConnectorError);
...
key being  the name of the key where an element was popped and the second element  being the value of the popped
element."}
    public native function bRPop (int timeOut, string[] keys) returns (map|RedisConnectorError);
    ...
    public native function lIndex (string key, int index) returns (string|RedisConnectorError);
 ...
 found"}
    ...
    public native function lLen (string key) returns (int|RedisConnectorError);
    ...
    public native function lRange (string key, int start, int stop)
        returns (string[]|RedisConnectorError);
    ...
    public native function lRem (string key, int count, string value) returns (int|RedisConnectorError);
    ...
    @Return {value:"A string with the value \"OK\" if the operation was successful"}
    public native function lTrim (string key, int start, int stop) returns (string|RedisConnectorError);
    ...
    public native function rPop (string key) returns (string|RedisConnectorError);
    ...
    public native function rPush (string key, string[] values) returns (int|RedisConnectorError);

    @Description {value:" Append one or multiple values to a list, only if the list exists"}
    @Param {value:"key:The key of the list"}
    @Param {value:"values:Array of values to be appended"}
    @Return {value:"The length of the list after the push operation"}
    public native function rPushX (string key, string[] values) returns (int|RedisConnectorError);
...
already present in the set"}
    public native function sAdd (string key, string[] values) returns (int|RedisConnectorError);

    @Description {value:"Get the number of members in a set"}
    @Param {value:"key:The key of the set"}
    @Return {value:"The cardinality (number of elements) of the set"}
    public native function sCard (string key) returns (int|RedisConnectorError);
    ...
    public native function sDiff (string[] keys) returns (string[]|RedisConnectorError);
...
sets and store at the provided destination"}
    ...
    @Return {value:"An array of members of the resulting set"}
    public native function sInter (string[] keys) returns (string[]|RedisConnectorError);
    ...
    public native function sIsMember (string key, string value) returns (boolean|RedisConnectorError);

    @Description {value:"Get all the members in a set"}
    @Param {value:"key:The key of the set"}
    @Return {value:"Array of all members in the set"}
    public native function sMembers (string key) returns (string[]|RedisConnectorError);
 ...
 operation was performed"}
    ...
    public native function sPop (string key, int count) returns (string[]|RedisConnectorError);
    ...
    public native function sRandMember (string key, int count) returns (string[]|RedisConnectorError);
    ...
    public native function sRem (string key, string[] members) returns (int|RedisConnectorError);
    ...
    public native function sUnion (string[] keys) returns (string[]|RedisConnectorError);
...
already present in the set for which the score was updated"}
    public native function zAdd (string key, map memberScoreMap) returns (int|RedisConnectorError);
    ...
    public native function zCard (string key) returns (int|RedisConnectorError);
    ...
    public native function zCount (string key, float min, float max) returns (int|RedisConnectorError);
    ...
    public native function zRange (string key, int min, int max) returns (string[]|RedisConnectorError);
...
lowest"}
    ...
    public native function zRank (string key, string member) returns (int|RedisConnectorError);
    ...
    public native function zRem (string key, string[] members) returns (int|RedisConnectorError);
    ...
    @Param {value:"member:The member of which the index needs to be obtained"}
    @Return {value:"The index of the member"}
    public native function zRevRank (string key, string member) returns (int|RedisConnectorError);
    ...
    public native function zScore (string key, string member) returns (float|RedisConnectorError);
    ...
    public native function zUnionStore (string dest, string[] keys) returns (int|RedisConnectorError);
    ...
    public native function hDel (string key, string[] fields) returns (int|RedisConnectorError);
...
field or key does not exist"}
    public native function hExists (string key, string field) returns (boolean|RedisConnectorError);

    @Description {value:"Get the value of a hash field"}
    @Param {value:"key:The key of the hash"}
    @Param {value:"field:The field"}
    @Return {value:"The value of the field"}
    public native function hGet (string key, string field) returns (string|RedisConnectorError);

    @Description {value:"Get the all values of a hash"}
    @Param {value:"key:The key of the hash"}
    @Return {value:"Map of field-value pairs"}
    public native function hGetAll (string key) returns (map|RedisConnectorError);
    ...
    public native function hKeys (string key) returns (string[]|RedisConnectorError);

    @Description {value:"Get the number of fields in a hash"}
    @Param {value:"key:The key of the hash"}
    @Return {value:"Number of fields"}
    public native function hLen (string key) returns (int|RedisConnectorError);

    @Description {value:"Get the values of all the given hash fields"}
    @Param {value:"key:The key of the hash"}
    @Param {value:"fields:Array of hash fields"}
    @Return {value:"Map of field-value pairs"}
    public native function hMGet (string key, string[] fields) returns (map|RedisConnectorError);

    @Description {value:"Set multiple hash fields to multiple values"}
    @Param {value:"key:The key of the hash"}
    @Param {value:"fieldValueMap:Map of field-value pairs"}
    @Return {value:"A string with the value \"OK\" if the operation was successful"}
    public native function hMSet (string key, map fieldValueMap) returns (string|RedisConnectorError);
 ...
 not exist at all"}
    public native function hStrln (string key, string field) returns (int|RedisConnectorError);
    ...
    public native function hVals (string key) returns (string[]|RedisConnectorError);
    ...
    public native function del (string[] keys) returns (int|RedisConnectorError);
    ...
    public native function exists (string[] keys) returns (int|RedisConnectorError);
    ...
    public native function expire (string key, int seconds) returns (boolean|RedisConnectorError);
    ...
    public native function keys (string pattern) returns (string[]|RedisConnectorError);
    ...
    public native function move (string key, int database) returns (boolean|RedisConnectorError);
 ...
 an associated timeout"}
    public native function persist (string key) returns (boolean|RedisConnectorError);
 ...
 be set"}
    ...
    public native function pTtl (string key) returns (int|RedisConnectorError);

    @Description {value:"Return a random key from the keyspace"}
    @Return {value:"The random key, or null when the database is empty"}
    public native function randomKey () returns (string|RedisConnectorError);

    @Description {value:"Rename a key"}
    @Param {value:"key:The key to be renamed"}
    @Param {value:"newName:The new name of the key"}
    @Return {value:"A string with the value \"OK\" if the operation was successful"}
    public native function rename (string key, string newName) returns (string|RedisConnectorError);
    ...
    public native function renameNx (string key, string newName) returns (boolean|RedisConnectorError);
    ...
    public native function sort (string key) returns (string[]|RedisConnectorError);
    ...
    public native function ttl (string key) returns (int|RedisConnectorError);

    @Description {value:"Determine the type stored at key"}
    @Param {value:"key:The key of which the type needs to be obtained"}
    @Return {value:"Time to live in seconds or a negative value in order to signal an error"}
    public native function redisType (string key) returns (string|RedisConnectorError);
    ...
    @Return {value:"A string with the value \"OK\" if the operation was successful"}
    public native function auth (string password) returns (string|RedisConnectorError);
