...
/**
 * {@code Set} Maps with "Append" operation of Redis.
 *
 * @since 0.5.0
 */
public class Append extends AbstractRedisAction {

    public static BInteger append(HandleValue redisDataSourceHandleValue, String redisKey, String redisValue) throws BallerinaException {
        try {
